...
- Docker
  ...
  - Dockerfiles
    - [Overview](/docker/dockerfiles/readme.md)
    - [Django](/docker/dockerfiles/django.md)
    ...
    - [WordPress](/docker/dockerfiles/wordpress.md)
...
- Jenkins
  ...
  - Jenkinsfiles
    ...
    - [Jenkinsfile Docs + Kubernetes](/jenkins/jenkinsfiles/Jenkinsfile-docs-k8s.md)
...
- Kubernetes
  ...
  - Manifests
    ...
    - [Go](/kubernetes/manifests/go/README.md)
    - [Java Microservice](/kubernetes/manifests/java-microservice/README.md)
    - [Jenkins](/kubernetes/manifests/jenkins/README.md)
    - [Laravel](/kubernetes/manifests/laravel/README.md)
